 ...
 */
fun maximalSubArray(array: Array<Double>, left: Int = 0, right: Int = array.size-1 ):Triple<Int,Int,Double> {
 ...
 *      in terms of extra space - O(1)
 */
fun maximalSubArrayKadane(array: Array<Double>, left: Int = 0, right: Int = array.size-1 ):Triple<Int,Int,Double> {
    if ( left > right ) return Triple(left, right, 0.0)
    var res = Triple(left, left, array[left])
    var sum = 0.0
    var l = left
